...
# then symlinks plugins/arena/skills/arena into ~/.claude/plugins/arena/skills/arena.
...
ln -s "$ARENA_DIR/plugins/arena/skills/arena" "$SKILL_LINK"
echo "[arena] symlinked $SKILL_LINK → $ARENA_DIR/plugins/arena/skills/arena"
